  ...
  const fetchWeather = useCallback(async () => {
    ...
    try {
      const response = await fetch(
        'https://api.open-meteo.com/v1/forecast?latitude=25.7907&longitude=-80.1300&current_weather=true&hourly=relative_humidity_2m'
      );
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-2xl font-header italic font-extrabold text-charcoal shadow-sm">SOUTH BEACH</h2>
          </div>
      ...
      >
        <div className="flex justify-between items-start">
          <div>
            ...
            <h2 className="text-2xl font-header italic font-extrabold text-charcoal">SATELLITE DATA</h2>
          </div>
